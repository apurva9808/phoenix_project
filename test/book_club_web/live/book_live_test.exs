defmodule BookClubWeb.BookLiveTest do
  use BookClubWeb.ConnCase

  import Phoenix.LiveViewTest
  import BookClub.CatalogFixtures

  @create_attrs %{description: "some description", author: "some author", title: "some title", isbn: "some isbn", cover_url: "some cover_url", publication_year: 42}
